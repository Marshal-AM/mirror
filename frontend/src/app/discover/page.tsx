...
export default function DiscoverPage() {
  ...
  return (
    <section className="section" id="discover">
      <h2>Discovery</h2>
      <p>
        Live leads on Coston2. Follow deposits FXRP into a vault; the next encrypted signal is copied for you.
        Scores are Sharpe, drawdown, consistency, and completeness from real fills.
      </p>
